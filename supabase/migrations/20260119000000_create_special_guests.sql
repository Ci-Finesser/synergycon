...
(
  ...
  'Visionary tech investor empowering the next generation of African innovators.',
  '["Founded 3 successful tech startups", "Invested in 50+ African companies", "Forbes Africa 30 Under 30 Alumna", "Trained 10,000+ women in tech"]'::JSONB,
  'The Future of Tech Investment in Africa',
  'Day 1 (Date TBA)',
  '10:00 AM - 11:30 AM',
...
(
  ...
  'Award-winning creative director shaping Africa''s most iconic brand identities.',
  '["Cannes Lions Award Winner", "One Show Gold Pencil", "Rebranded 100+ African companies", "TEDx Speaker on African Creativity"]'::JSONB,
  'Building Iconic African Brands',
  'Day 1 (Date TBA)',
  '2:00 PM - 3:30 PM',
  'National Theatre - Main Stage',
...
(
  ...
  'Pioneering sustainable fashion with traditional African craftsmanship.',
  ...
  'Sustainable Fashion: The African Advantage',
  'Day 2 (Date TBA)',
  '11:00 AM - 12:30 PM',
...
(
  ...
  'Chidi Amaechi is a renowned film director whose works have premiered at major international film festivals including Toronto, Sundance, and Cannes. His storytelling captures the complexity of African experiences with cinematic brilliance. With over two decades in the industry, Chidi has directed 25+ feature films and mentored a new generation of African filmmakers. He is currently developing Africa''s largest film production hub.',
  'Acclaimed filmmaker bringing African stories to the global stage.',
  '["25+ Feature Films Directed", "Toronto Film Festival Selection", "Africa Movie Academy Award Winner", "Mentored 200+ filmmakers"]'::JSONB,
  'African Cinema: Beyond Borders',
  'Day 2 (Date TBA)',
  '3:00 PM - 4:30 PM',
...
(
  ...
  'Grammy-nominated producer crafting the future of African music.',
  '["Grammy Nomination for Best African Album", "Produced 50+ Gold/Platinum records", "Trained 500+ upcoming producers", "Built Africa''s top recording studio"]'::JSONB,
...
(
  ...
  'Olumide Johnson is a pioneering game developer who founded AfroGaming Labs, a studio focused on creating games that celebrate African culture and mythology. His flagship title, "Kingdoms of Ife," has been downloaded over 5 million times globally. Olumide is also a leading voice in the XR (Extended Reality) space, developing immersive experiences that showcase African heritage. He actively contributes to growing the gaming ecosystem across the continent.',
  'Game developer bringing African mythology to the digital world.',
  '["5M+ Game Downloads Worldwide", "Unity Certified Developer", "Founded Africa''s largest game studio", "XR Africa Pioneer Award"]'::JSONB,
  'Gaming Africa: From Stories to Screens',
  'Day 3 (Date TBA)',
  '11:00 AM - 12:30 PM',
...
(
  ...
  'Amara Obi is an internationally acclaimed visual artist and sculptor whose works have been exhibited at the Smithsonian, Tate Modern, and the Museum of African Art in Paris. Her large-scale installations explore themes of identity, migration, and cultural preservation. Through the Obi Art Foundation, she provides residencies and grants to emerging African artists, helping them gain international exposure and develop their craft.',
  'World-renowned sculptor exhibiting at major global museums.',
  '["Exhibited at Smithsonian & Tate Modern", "Installed 15+ public sculptures", "Founded arts residency program", "African Artist of the Year 2024"]'::JSONB,
