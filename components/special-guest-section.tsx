...
const sampleGuests: SpecialGuest[] = [
  {
    ...
    shortBio: "Visionary tech investor empowering the next generation of Nigerian innovators.",
    achievements: [
    ...
    sessionTitle: "The Future of Tech Investment in Nigeria",
  ...
  },
  {
    ...
    shortBio: "Award-winning creative director shaping Nigeria's most iconic brand identities.",
    achievements: [
    ...
    sessionTitle: "Building Iconic Nigerian Brands",
    sessionDate: EVENT_DATES.datesAnnounced ? "Day 1" : "Day 1 (Date TBA)",
  ...
  },
  {
    ...
    shortBio: "Pioneering sustainable fashion with traditional Nigerian craftsmanship.",
    achievements: [
    ...
    sessionTitle: "Sustainable Fashion: The Nigerian Way",
  ...
  },
  {
    ...
    bio: "Chidi Amaechi is a critically acclaimed filmmaker whose works have premiered at major international film festivals including Toronto, Sundance, and Berlin. His films explore themes of identity, migration, and the Nigerian diaspora experience. Chidi is committed to developing the Nigerian film industry, having established a film school in Lagos that has trained over 200 emerging filmmakers. His latest project secured distribution deals across 40 countries.",
    shortBio: "Acclaimed filmmaker bringing Nigerian stories to the global stage.",
    achievements: [
    ...
    sessionTitle: "Nigerian Cinema's Global Moment",
    sessionDate: EVENT_DATES.datesAnnounced ? "Day 2" : "Day 2 (Date TBA)",
    sessionTime: "2:00 PM - 3:30 PM",
  ...
  },
  {
    ...
    sessionTitle: "The Business of Nigerian Music",
  ...
  },
  {
    ...
    bio: "Olumide Adebayo is at the forefront of Nigeria's digital art revolution. As a visual artist and technologist, he has created groundbreaking works that have sold for record prices in the NFT space. His gallery, ArtBlock Lagos, is the first dedicated digital art space in West Nigeria, showcasing works from emerging Nigerian digital artists. Olumide's mission is to democratize art ownership and provide Nigerian artists with new revenue streams through blockchain technology.",
    shortBio: "Leading Nigeria's digital art revolution through blockchain and NFTs.",
    achievements: [
      "NFT sales exceeding $2M",
      "Founded first Nigerian NFT gallery",
  ...
  },
  {
    ...
    bio: "Zainab Musa built a media empire from her bedroom, growing from a content creator to the CEO of AfriTrend Media, a multi-platform media company reaching over 50 million viewers monthly. Her authentic approach to content creation has made her one of Nigeria's most influential digital voices. Zainab is passionate about helping young Nigerians monetize their creativity and has launched creator economy programs that have helped thousands turn their passion into profitable careers.",
