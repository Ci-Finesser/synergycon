...
('Osayi Alile', 'Senior Partner', 'Ms. Osayi Alile is a Senior Partner at PWC Nigeria, specializing in consulting for creative industries, media, and entertainment. She advises on strategic growth and market expansion across Africa.', 'PWC Nigeria', true, 5, '/professional-portrait-of-african-female-consultant.jpg'),
...
('Chalya Shagaya', 'Founder & Managing Partner', 'Shagaya Ventures', 'SynergyCon is exactly what Nigeria''s creative economy needs - a platform that brings together innovators, investors, and policymakers to drive real change.', 1, '/professional-portrait-of-african-female-tech-inves.jpg'),
('Iyinoluwa Aboyeji', 'Co-Founder', 'Future Africa', 'This conference showcases the incredible talent and innovation happening in Nigeria''s creative sector. The future is bright for our creative economy.', 2, '/professional-portrait-of-nigerian-tech-entrepreneu.jpg'),
...
('Osayi Alile', 'Senior Partner', 'PWC Nigeria', 'An exceptional gathering of thought leaders and industry experts. The conversations here are shaping the future of Nigeria''s creative industries.', 4, '/professional-portrait-of-african-female-consultant.jpg');
...
('Africa No Filter', '/africa-no-filter-logo.jpg', 'ecosystem', 'https://africanofilter.org', 10);
